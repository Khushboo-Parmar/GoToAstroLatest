...
export default function Search({ setPrice, setName ,page,setFilter}) {
    ...
    return (
        <>
            ...
            <View style={{ marginVertical: responsiveHeight(1) }}>
                ...
                setTabs(false)
                setPrice([])
                }}><Text style={[style.black, { fontWeight: 'bold', fontSize: responsiveFontSize(1.5) }]}>Free Report</Text></TouchableOpacity>
                    <TouchableOpacity onPress={()=>setFilter('paid')}><Text style={[style.black, { fontWeight: 'bold', fontSize: responsiveFontSize(1.5) }]}>Paid Report</Text></TouchableOpacity>
                    </> 
                    }
